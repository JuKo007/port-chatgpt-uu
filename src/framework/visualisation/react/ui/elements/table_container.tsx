...
const translations = {
  searchPlaceholder: new TextBundle().add("en", "Search").add("nl", "Zoeken").add("de", "Suchen"),
  showTable: new TextBundle().add("en", "Show table").add("nl", "Tabel tonen").add("de", "Tabelle anzeigen"),
  hideTable: new TextBundle().add("en", "Hide table").add("nl", "Tabel verbergen").add("de", "Tabelle verbergen"),
}
