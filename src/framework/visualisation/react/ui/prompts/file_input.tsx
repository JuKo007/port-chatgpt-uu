...
const note = (): Translatable => {
  return new TextBundle()
    ...
    .add('de', 'Hinweis: Der Prozess zum Extrahieren der richtigen Daten aus der Datei wird auf Ihrem eigenen Computer durchgeführt. Es werden noch keine Daten gespeichert oder gesendet.')
}
